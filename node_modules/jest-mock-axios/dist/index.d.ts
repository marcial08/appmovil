...
declare type MockUnresolvedPromise = (url?: string, options?: any) => UnresolvedSynchronousPromise<any>;
declare type MockUnresolvedPromiseBody = (url?: string, body?: any, options?: any) => UnresolvedSynchronousPromise<any>;
interface AxiosAPI {
 ...
 */
declare type AxiosMockType = AxiosAPI & AxiosMockAPI & jest.Mock<(options?: any) => any>;
